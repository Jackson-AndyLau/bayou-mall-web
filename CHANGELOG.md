...
- 修复菜单按钮权限错误bug [#41](https://github.com/bayouio/bayou-mall-web/issues/41)
...
- 优化完善mock模拟数据
- 修复linux系统，引入主题色文件名大小写编译错误bug [#22](https://github.com/daxiongYang/bayou-mall-web/issues/22)
...
- 修复1.2 新版本的导航栏Tab错位bug [#14](https://github.com/daxiongYang/bayou-mall-web/issues/14)
- 修复动态菜单路由 最前面带/bug
- 修复其它已知bug
